...
class  Texts{
	/**静态目录常量*/
	public static $Tabi='<table  cellpadding="3" border="1">
										<tr>
										...
										<td style="text-align:center;" rowspan="4">操作规范</td>
	...
	public static $Tabii='<table  cellpadding="3" border="1">
										...
										<td style="text-align:center;" rowspan="3">客休区服务及设施</td>
										<td style="text-align:center;" rowspan="3">%s</td>
										</tr>
										<tr>
										<td>S9、休息区是否舒适整洁？</td>
	...
	public static $Tabiii='<table  cellpadding="3" border="1">
										<tr>
										<td width="50%" style="text-align:center; background-color:#538DD5;">三级指标</td>
										<td width="30%" style="text-align:center;background-color:#538DD5;">汇总指标</td>
										<td width="20%" style="text-align:center;background-color:#538DD5;">加权得分</td>
										...
										<td style="text-align:center;" rowspan="3">维修保养结果</td>
										<td style="text-align:center;"rowspan="3">%s</td>
										</tr>
										<tr>
										<td>Z5、维修保养的过程是否透明？</td>
										</tr>
										<tr>
	...
	public static $Tabiv='<table  cellpadding="2" border="1">
										...
										<td style="text-align:center;background-color:#538DD5;">加权得分</td></tr>
										<tr>
										<td>T2、预约是否有优惠？</td>
										...
										<tr>
										<td>T4、进入接待区是否需要等待？</td>
										</tr>
										<tr>
										<td>T11、完工后交车是否需要等待？</td>
										</tr>
										<tr>
										<td>T12、付款结算环节是否需要等待？</td>
										</tr>
										</table>';
	...
	const  TitleFouII2_1_3='2.1.3	服务顾问探查分析';
	const  TitleFouII2_1_4='2.1.4	服务顾问改进分析';
	const  TitleFouII2_2_1='2.2.1	服务设施指标得分情况';
	const  TitleFouII2_2_2='2.2.2	服务设施指标细项归纳得分情况';
	const  TitleFouII2_2_3='2.2.3	服务设施探查分析';
	const  TitleFouII2_2_4='2.2.4	服务设施改进分析';
	const  TitleFouII2_3_1='2.3.1	维修保养质量指标得分情况';
	const  TitleFouII2_3_2='2.3.2	维修保养质量指标细项归纳得分情况';
	const  TitleFouII2_3_3='2.3.3	维修保养质量探查分析';
	const  TitleFouII2_3_4='2.3.4	维修保养质量改进分析';
	const  TitleFouII2_4_1='2.4.1	维修保养时间指标得分情况';
	const  TitleFouII2_4_2='2.4.2	维修保养时间指标细项归纳得分情况';
	const  TitleFouII2_4_3='2.4.3	维修保养时间探查分析';
	const  TitleFouII2_4_4='2.4.4	维修保养时间改进分析';
	const  TitleFouII2_5_1='2.5.1	维修保养价格指标得分情况';
	const  TitleFouII2_5_2='2.5.2	维修保养价格指标细项归纳得分情况';
	const  TitleFouII2_5_3='2.5.3	维修保养价格探查分析';
	const  TitleFouII2_5_4='2.5.4	维修保养价格改进分析';
	/**全文搜索五级**/
