...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'CADA.png')) {
		$tcpdf_header_logo = 'CADA.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'CADA');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'CADA');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'CADA');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "BY CADA-www.51hyc.com");
}
