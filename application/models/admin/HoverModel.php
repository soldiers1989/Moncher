...
class HoverModel extends CI_Model {
	/**
	 ***********************************************************
	 *方法::HoverModel::__construct
	 * ----------------------------------------------------------
	 * 描述::初始化方法
	 *----------------------------------------------------------
	 *参数:
	 ...
	 ************************************************************
	 */
	public function getHoverList($type=1,$open=0,$last=100,$order='id',$desc='DESC'){
		if($type==1){
			...
			$query=$this->db->query('SELECT * FROM cada_hover_log WHERE status=1');
			return $query->num_rows();
		}
	}
	/**
	 ***********************************************************
	 *方法::HoverModel::getSearch
	 * ----------------------------------------------------------
	 * 描述::获取列表分页及数量方法
	 *----------------------------------------------------------
	 *参数:
