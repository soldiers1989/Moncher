...
class HoverService{
	...
	public function __construct(){
		...
		$this->includes->models('HoverModel');
	...
	public function getList($page){
		try{
			...
			$list=$model->getHoverList(1,($page-1)*100,100);
	...
	/**
	 ***********************************************************
	 *方法::HoverService::getSearchTotal
	 * ----------------------------------------------------------
	 * 描述::获取搜索所有记录行数
	 *----------------------------------------------------------
